...
public class AdaptadorMyMangaList extends BaseAdapter {
    private Context context;
    private List<MangaDB> listItems;

    public AdaptadorMyMangaList(Context context, List<MangaDB> listItems) {
    ...
    @Override
    public MangaDB getItem(int position) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final MangaDB item = this.getItem(position);
